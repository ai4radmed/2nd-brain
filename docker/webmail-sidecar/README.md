...
Playwright 공식 이미지(full chromium 크래시 無) + headed(`WEBMAIL_HEADED=1`, SPA 렌더) + **Xvfb 직접 기동**(래퍼 행 회피). 상세: [`../../docs/openclaw-docker-install.md`](../../docs/openclaw-docker-install.md) §9b, 메모리 `project-openclaw-docker-migration`.
